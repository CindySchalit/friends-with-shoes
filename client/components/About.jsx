...
const About = () => {
  return (
    <div className="aboutBody">
      ...
      <p className="aboutParagraph">Friends with Shoes is a meeting place for people who have feet of different sizes. For such persons, shoe shopping can be a hassle because they typically have to buy two pairs of the same shoe.</p>
      ...
      <p className="aboutParagraphLast">Friends with Shoes is a marketplace where the reciprocally lopsided can exchange these extra shoes.</p>
